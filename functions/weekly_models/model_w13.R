model_w13 <- function(gdp, attention_bridge, esi_bridge, cpi_bridge, vacancies_bridge, term_spread_prep, ip_index, period_preselection, min_train, max_train, max_test){
