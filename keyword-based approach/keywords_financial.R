...
keyword_collapsed <- keyword_financial.csv %>% 
...
plot_timeseries <- ggplot(time_series_z) +
  ...
  scale_y_continuous(name = "Financial Markets") +
  theme_classic() +
