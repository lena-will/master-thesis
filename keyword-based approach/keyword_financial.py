...
def main(folder_name):
    ...
    # keyword indicator
    keywords = {"bank", "derivate", "anleihen", "immobilienmarkt", "aktienmarkt", "aktienmärkte", "immobilienmärkte", "anleihe", "kaptialmarkt", "kaptialmärkte", "staatsanleihe", "staatsanleihen", "aktie", "aktien", "wechselkurs", "wechselkurse", "versicherung", "versicherungen", "versicherungsrate"}
    ...
    keyword_indicator.to_csv(path / "keyword_financial.csv", encoding="utf-8-sig")
