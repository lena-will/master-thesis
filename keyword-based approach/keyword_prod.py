...
def main(folder_name):
    ...
    # keyword indicator
    keywords = {"produktion", "gewerbe", "fabrik", "fabriken", "werk", "betrieb", "betriebe" "herstellung", "erzeugung", "fertigung", "fertigungen"}
    ...
    keyword_indicator.to_csv(path / "keyword_prod.csv", encoding="utf-8-sig")
